    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-surface-950 via-surface-900 to-cool-950 px-4">
      <div className="w-full max-w-md">
          ...
          <form onSubmit={mode === "login" ? handleLogin : handleRegister} className="space-y-4">
            {mode === "register" && (
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl bg-surface-900 border border-slate-700 text-white placeholder-slate-500 focus:border-cool-500 focus:ring-1 focus:ring-cool-500 outline-none transition"
                />
              </div>
            )}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                required
                placeholder={mode === "login" ? "username or email" : "unique username"}
                className="w-full px-4 py-2.5 rounded-xl bg-surface-900 border border-slate-700 text-white placeholder-slate-500 focus:border-cool-500 focus:ring-1 focus:ring-cool-500 outline-none transition"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl bg-cool-600 hover:bg-cool-500 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold flex items-center justify-center gap-2 transition shadow-lg shadow-cool-600/25"
            >
              {loading ? (
                <>
                ...
                <>
                  ...
                  {mode === "login" ? "Enter COOLBLOX" : "Create Account"}
                </>
              )}
            </button>
          </form>
        ...
        <p className="text-center text-xs text-slate-500 mt-6">
          By continuing you agree to the COOLBLOX-GROX Terms of Service.
        </p>
      </div>
    </div>
  );
